...
angular.module('webui.plugins').controller('PluginsIndexController', function($scope, $q, $http, notify, pageTitle, messagebox, tasks, core, gettext) {
    ...
    $scope.upgradeEverything = () =>
        tasks.start(
            'wu.plugins.plugins.tasks.UpgradeAll', [], {}
        )
    ...
    $scope.installPlugin = (plugin) => {
        ...
        return tasks.start(
            'wu.plugins.plugins.tasks.InstallPlugin',
            [],

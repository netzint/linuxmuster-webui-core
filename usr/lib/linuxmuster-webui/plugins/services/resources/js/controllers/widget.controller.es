angular.module('webui.services').controller('ServiceWidgetController', ($scope, services, notify, gettext) => {
...
angular.module('webui.services').controller('ServiceWidgetConfigController', ($scope, services) => {
    $scope.services = [];

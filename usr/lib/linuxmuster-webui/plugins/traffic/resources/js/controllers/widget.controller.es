angular.module('webui.traffic').controller('TrafficWidgetController', ($scope, notify) => {
    $scope.oldData = {};
...
angular.module('webui.traffic').controller('TrafficWidgetConfigController', ($scope, $http) => {
    $scope.traffic = [];
